----------------------------------------------------------------------------
 Donkie Kung: Championship Edition
----------------------------------------------------------------------------

  INSTALLATION:
  =============

  Donkie  Kung is  designed for the  Palm Computing Platform.  'dkung.prc'
  ...
  17-Aug-2001: *eek* - fixed level resetting after collecting 4 keys!
               thanks to Mario Bridges for reporting this feature :P
 
  10-Aug-2001: native handera 330 support! (both screens on screen!)
               minor cosmetic changes throughout application
  ...
  16-Jan-2001: adjustments made to upper layer switch to favour mario :))
               [more likely to move up, than down - so blind spot @ lower]

  17-Jan-2001: modification to use 4bpp (16 color) screen depth in color

  You  should install  the latest version of  Donkie Kung onto your device
  Donkie Kung can be installed and executed from flash memory! 

            http://www.ardiri.com/index.cfm?redir=palm&cat=dkung
  ...
  Start Donkie Kung by tapping on the application icon in  the application
  launcher.  After a  short while,  you will be  presented  with  the main 
  Donkie Kung screen  in which you may select the type of game you wish to 
  ...
  Using  the  hard keys or the stylus,  you must  move  Maryo through  the 
  industrial landscape avoiding tumbling barrels and moving steel  bars to 
  grab keys that hold the platform Donkie Kung is standing on and save the 
  captured  girl.  You  may  configure the  key  and  sound volume in  the 
  configuration  screen.  You get  to  this by  selecting  the  menu  item  
  ...
  Donkie  Kung is shareware,  the demonstration version does not allow the 
  player to generate high score  codes or the ability to save the captured
  girl more than once. To access  these  features, a device identification 
  ...
  REGISTRATION IS $5 and can be made at PalmGearHQ and are not refundable.
  Once  your purchase is  made,  you will receive a serial number that you 
  will then need to  enter when  you fill in  survey at the  following web 
  address:

    http://www.ardiri.com/index.cfm?redir=palm&cat=dkung&subcat=survey

  Payments support future developments and the developer.  If you paid for 
  this software in another manner -  you have been ripped off.  Report any 
  occurances by sending an email to aaron@ardiri.com
  ...
  Thankyou for downloading and playing Donkie Kung! 
